...
# ## Features
# 
# As you can notice the data above isn't linearly separable. Since that we should add features (or use non-linear model). 
#Note that decision line between two classes have form of circle, since that we can add quadratic features to make the problem linearly separable. 
#The idea under this displayed on image below:
# 
# ![](kernel.png)
# In[6]:
def expand(X):
