# -*- coding: utf-8 -*-
"""
Created on Sat Feb 23 02:29:21 2019
...
ap.add_argument("-m", "--model", required=False, default="./output/trainlenet.hdf5", help="path to output model")
...
for imagePath in paths.list_images(args["dataset"]):
    ...
    # extract the class label from the image path and udpate the labels list
...
# partitions the data into training and testing splits using 75% of the data for training 
