# -*- coding: utf-8 -*-
"""
Created on Tue Feb 12 23:28:30 2019
...
ap.add_argument("-o", "--output", required=False, default="output/cifar10_lr_decay.png", help="path to the output loss/accuracy plot")
