# -*- coding: utf-8 -*-
"""
Created on Fri Feb 15 18:14:29 2019
...
ap.add_argument("-o", "--output", required=False, default="output", help="path to the output directory")
args = vars(ap.parse_args())

# show information on the process ID
print("[INFO] process ID: {}".format(os.getpid()))
# load the training and testing data, then scale it into the range [0, 1]
print("[INFO] load CIFAR-10 data...")
