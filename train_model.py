# -*- coding: utf-8 -*-
"""
Created on Sun Feb 24 19:13:17 2019
...
ap.add_argument("-d", "--dataset", required=False, default="./datasets/SMILEsmileD", help="path to input dataset of faces")
ap.add_argument("-m", "--output", required=False, default="lenet.hdf5", help="path to output model")
