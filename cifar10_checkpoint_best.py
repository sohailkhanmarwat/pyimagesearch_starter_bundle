# -*- coding: utf-8 -*-
"""
Created on Sat Feb 16 22:18:32 2019
...
ap.add_argument("-w", "--weights", required=False, default="weights/best/cifar10_best_weights.hdf5", help="path to weight directory")
